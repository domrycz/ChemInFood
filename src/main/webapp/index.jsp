...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Cabin+Sketch|Caveat+Brush">
    <title>ChemInFood</title>
    <style>
        .jumbotron {
...
<main>
    <div class="jumbotron text-center">
        <h2>ChemInFood</h2>
        <h3>This app will help you to buy more healthy products!</h3>
